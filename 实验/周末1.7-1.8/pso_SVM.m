...
% %读取训练数据
train_label=csvread('E:\traffic_data\worked_data\20170107traffic.csv',2,2,[2 2 103 2]);
train_data=csvread('E:\traffic_data\worked_data\20170107traffic.csv',1,1,[1 1 102 2]);
train_len = length(train_label)

% %读取测试数据
test_label=csvread('E:\traffic_data\worked_data\20170108traffic.csv',2,2,[2 2 103 2]);
test_data=csvread('E:\traffic_data\worked_data\20170108traffic.csv',1,1,[1 1 102 2]);
