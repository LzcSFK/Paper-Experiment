...
% %读取训练数据
train_label=csvread('E:\traffic_data\weibo_data\ID=1-7-15.csv',2,2,[2 2 79 2]);
train_data=csvread('E:\traffic_data\weibo_data\ID=1-7-15.csv',1,1,[1 1 78 2]);
train_len = length(train_label)

% %读取测试数据
test_label=csvread('E:\traffic_data\weibo_data\ID=1-7-01.csv',2,2,[2 2 79 2]);
test_data=csvread('E:\traffic_data\weibo_data\ID=1-7-01.csv',1,1,[1 1 78 2]);
